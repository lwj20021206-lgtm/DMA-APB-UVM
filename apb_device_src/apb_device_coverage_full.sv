...
// This file expects uvm_pkg, uvm_macros.svh, apb_intf,
...
class apb_device_coverage_full extends uvm_component;
  ...
  function void build_phase(uvm_phase phase);
    ...
    have_master_vif = uvm_config_db#(virtual apb_intf)::get(
      this, "", "APB_VMINTF", APB_VMINTF
    );
    have_slave_vif = uvm_config_db#(virtual apb_intf)::get(
  ...
  task monitor_master_interface();
    ...
    forever begin
      ...
      if (previous_resetn && !APB_VMINTF.presetn) begin
      ...
      previous_resetn = APB_VMINTF.presetn;
    end
  endtask
  ...
  task monitor_slave_interface();
    ...
    forever begin
      ...
      if (have_master_vif && !APB_VMINTF.presetn) begin
        in_transfer = 1'b0;
        wait_cycles = 0;
      end
