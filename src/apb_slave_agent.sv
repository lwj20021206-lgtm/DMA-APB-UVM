class apb_slave_agent extends uvm_agent;
  ...
  function void build_phase(uvm_phase phase);
    ...
    uvm_config_db#(virtual apb_intf)::set(this, "apb_slave_monitor_1", "APB_VSINTF", APB_VSINTF);
    uvm_config_db#(virtual apb_intf)::set(this, "apb_slave_driver_1", "APB_VSINTF", APB_VSINTF);
  endfunction
