class apb_master_agent extends uvm_agent;
  ...
  function void build_phase(uvm_phase phase);
    ...
    uvm_config_db#(virtual apb_intf)::set(this, "apb_master_monitor_1", "APB_VMINTF", APB_VMINTF);
    uvm_config_db#(virtual apb_intf)::set(this, "apb_master_driver_1", "APB_VMINTF", APB_VMINTF);
  endfunction
